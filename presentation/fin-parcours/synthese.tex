...
\begin{tikzpicture}
    ...
    \node [right, orange] at (6, 0.5) {Attaque relai (tiers abusé)};
...
\begin{frame}{App actuelle}
    ...
    \begin{minipage}{.3\textwidth}
        \centering
        \includegraphics[width=.7\linewidth]{../assets/android2}
    \end{minipage}
...
\begin{frame}{Traitement du signal}
  \centering
  \includegraphics[width=.6\linewidth]{../assets/uml_signal}
\end{frame}
