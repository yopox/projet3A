...
\begin{tikzpicture}
    ...
    \node [below, red] at (1.32, -0.54) {A};

    \draw [fill, red] (3,-1) circle [radius=0.05];
    \node [right, red] at (3,-1) {Tag};
    \draw [->, thick, dashed, line width=1.2, red] (2.79,-0.93) -- (1.51,-0.5);
    \draw [->, thick, line width=1.2, red] (1.1,-0.37) -- (0.47,-0.16);
    \node [right, red] at (4.5,1) {Mafia fraud};
    ...
    % Impersonation fraud
    \draw [cyan, thick] (-1.32,-0.44) circle [radius=0.3];
    \node [below, cyan] at (-1.32, -0.74) {A};
    \draw [fill, cyan] (-1.17,-0.44) circle [radius=0.05];
    \draw [fill, cyan] (-1.32,-0.29) circle [radius=0.05];
    \draw [fill, cyan] (-1.47,-0.44) circle [radius=0.05];
    \draw [fill, cyan] (-1.32,-0.44) circle [radius=0.05];
    \draw [fill, cyan] (-1.32,-0.59) circle [radius=0.05];
    \draw [->, thick, line width=1.2, cyan] (-1.04,-0.35) -- (-0.47,-0.16);
    \node [right, cyan] at (4.5,-1) {Impersonation fraud};
